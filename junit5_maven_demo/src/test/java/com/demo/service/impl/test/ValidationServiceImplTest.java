...
class ValidationServiceImplTest {
	...
	void testIsVaidPrimeNumberTrue() {
		...
		Assertions.assertTrue(service.isValidPrimeNumber(3));
	}
	
	@Test
	void testIsVaidPrimeNumberFalse() {
		//fail("Not yet implemented");
		Assertions.assertFalse(service.isValidPrimeNumber(4));
	}
	
	@Test
	void testIsVaidPrimeNumberNegativeCheck() {
		//fail("Not yet implemented");
		Assertions.assertFalse(service.isValidPrimeNumber(-3));
	}
